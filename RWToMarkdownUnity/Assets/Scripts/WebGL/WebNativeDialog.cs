...
public class WebNativeDialog
{
    ...
    [DllImport("__Internal")]
    private static extern string SetupOverlayDialogHtml(string title , string defaultValue,string okBtnText);
    ...
    public static void SetUpOverlayDialog(string title, string defaultValue, string okBtnText)
    {
#if UNITY_WEBGL && !UNITY_EDITOR
        ...
        SetupOverlayDialogHtml(title, defaultValue,okBtnText);
#else
#endif
    }
